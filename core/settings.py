...
Generated by 'django-admins startproject' using Django 5.2.5.
...
SECRET_KEY = 'django-insecure-phqv=haxst6+ew$==z27jmhpu1h$bruy5t(#y!9nfisa6v(uj1'
...
DATABASES = {
    'default': {
        ...
        'HOST': config.DB_HOST,  # or the container name if using Docker
        'PORT': config.DB_PORT,
    }
}
